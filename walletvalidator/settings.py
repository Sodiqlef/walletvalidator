"""
Django settings for walletvalidator project.
...
SECRET_KEY = 'django-insecure--pjs4y_6ww0(4-=&17+mwk%++$(oc31%x9^k^c0f3xw6$crfo$'
...
ROOT_URLCONF = 'walletvalidator.urls'
...
WSGI_APPLICATION = 'walletvalidator.wsgi.application'
